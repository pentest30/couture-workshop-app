...
namespace Couture.Identity.Migrations
{
    ...
    [Migration("20260329195309_FixIsActiveDefault")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Couture.Identity.Domain.CoutureRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Couture.Identity.Domain.CoutureUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Couture.Identity.Domain.CoutureRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Couture.Identity.Domain.CoutureUser", null)
                        .WithMany()
